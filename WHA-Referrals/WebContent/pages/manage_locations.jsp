...
<html>
	<head>
	    ...
	    <title>WHA-Referrals | Location Management</title>
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol id="breadcrumbTarget" class="breadcrumb">
		            	...
		            	<li class="active"><a href="#"><i class="fa fa-group"></i> Location Management</a></li>
					</ol>
        		</section>
               							...
               							<tbody>
											<c:forEach var="list_def" items="${list_defs.rows}">
												<tr id="list_entry_row_<c:out value="${list_def.id}" />">
									                ...
									                <td><c:out value="${list_def.location}" /></td>
									                <td></td>
									                <td>
									                	<button class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit Entry" onclick="getLocationItemEditInlineForm(<c:out value="${list_def.id}" />,'<c:out value="${list}" />');">
...
function getLocationItemEditInlineForm(list_item_id, list_name) {
	$.ajax({
		type: 'POST',
		url: '../ajax/getLocationItemEditInlineForm.jsp',
