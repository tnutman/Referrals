...
public class UpdateLocationDef extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateLocationDef.class.getName()).log(Level.SEVERE, null, ex);
            int errorCode = 500;
	...
	private void processRequest(HttpServletRequest request,
		...
		if (httpSession.getAttribute("u_id") == null) {
			...
			String sqlString = "UPDATE " + request.getParameter("list") + " SET location = '" + request.getParameter("list_entry") + "' WHERE id = " + request.getParameter("list_entry_id") +";";
			...
			String redirectString = "pages/manage_locations?list="+request.getParameter("list");
			response.sendRedirect(redirectString);
		}
	}
